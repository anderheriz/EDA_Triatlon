...
1. Ejecutar `codigo/API.py` si se quieren descargar de nuevo los datos originales.
2. Ejecutar `notebook/recopilacion_limpieza_datos.ipynb` para regenerar los CSV combinados y el dataset limpio.
3. Abrir `memoria.ipynb` para consultar el análisis final y las conclusiones.
